...
`seq_floyd_warshall_shortest_paths(g, distmx)`: 806.479 ms (5 allocations: 15.26 MiB)

`parallel_floyd_warshall_shortest_paths(g, distmx)`: 592.930 ms (1005 allocations: 15.32 MiB)

---

`g = random_regular_graph(2000, 20)`

`seq_floyd_warshall_shortest_paths(g, distmx)`: 6.548 s (5 allocations: 61.04 MiB)

`parallel_floyd_warshall_shortest_paths(g, distmx)`: 4.997 s (2005 allocations: 61.16 MiB)

---

`g = random_regular_graph(3000, 30)`

`seq_floyd_warshall_shortest_paths(g, distmx)`: 21.194 s (5 allocations: 137.33 MiB)

`parallel_floyd_warshall_shortest_paths(g, distmx)`: 16.924 s (3005 allocations: 137.51 MiB)  
